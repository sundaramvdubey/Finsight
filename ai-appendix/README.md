...
- [x] Raw data assembled (24 months, app-wise) and loaded to Supabase
- [x] SQL: market share over time (window fn), MoM growth, rankings, CTE
      concentration query
- [x] Cleaning notes logged as they happen (not reconstructed after)
- [x] EDA: growth trend, seasonality, concentration curve
- [x] Linear regression: next-quarter volume projection, error reported
      honestly, overfitting check, named risks to the projection
- [ ] Dashboard (owner: TBD)
- [x] One-page memo: broadening or concentrating, evidence, so-what for CRED
- [x] AI appendix: real example of catching AI being wrong
- [ ] 3-minute walkthrough video (owner: TBD)

## Status

Days 1–4 complete (data assembly, SQL, cleaning, EDA, model, memo). Effective
analysis window is 19 of 24 months — see DECISIONS.md for why. Dashboard and
video walkthrough remain, owned by other team members per TEAM_MEMBERS.md.
